...
import com.englishlearning.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) throws Exception {
        ...
        if (!authenticated) throw new Exception();
    ...
    private SignedJWT verifyToken(String token, boolean isRefresh) throws Exception {
        ...
        if (!(verified && expiryTime.after(new Date()))) throw new Exception("Unauthenticated");
